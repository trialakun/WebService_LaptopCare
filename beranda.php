        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="beranda.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Beranda</h3>
                </a>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <div class="ms-3">
                                <p class="mb-2">Laptop Care</p>
                                <h6 class="mb-0">Optimalkan kesehatan dan kinerja laptop anda dengan solusi terpadu dari Laptop Care - teman setia untuk menjaga performa laptop anda</h6>
                            </div>
                        </div>
                    </div>
                    </div>
