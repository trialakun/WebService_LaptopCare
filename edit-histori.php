...
include 'koneksi.php';
//edit
$data_edit = mysqli_query($koneksi, "SELECT * FROM histori WHERE id_histori ='".$_GET['id_histori']."'");
...
<form class="row justify-content-center" action="" method="post" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td>:</td>
    <td>
<input type="text" name="judul_histori" value="<?php echo $hasil['judul_histori']; ?>" class="form-control">
    </td>
  </tr>
  <tr>
    <td>Deskripsi Histori</td>
    <td>:</td>
    <td>
<input type="text" name="des_histori" value="<?php echo $hasil['des_histori']; ?>" class="form-control">
    </td>
  </tr>
...
<?php
if (isset($_POST['edit'])){
  $update = mysqli_query($koneksi, "UPDATE histori SET judul_histori ='".$_POST['judul_histori']."', des_histori ='".$_POST['des_histori']."'
  WHERE id_histori ='".$_GET['id_histori']."'");
if ($update) {
  // code...
