        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="beranda.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Data Aplikasi</h3>
                </a>
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    <th scope="col">No</th>
                                    <th scope="col">Id Care</th>
                                    <th scope="col">Judul Care</th>
                                    <th scope="col">Deskripsi Care</th>
                            ...
                            <tbody>
                              <?php
                              $no = 1;
                              $query = mysqli_query($koneksi, "SELECT * FROM care");
                              while ($data = mysqli_fetch_assoc($query)) {
                              ?>
                                <tr>
                                  <td><?php echo $no++; ?></td>
                                  <td ><?php echo $data['id_care']; ?></td>
                                  <td><?php echo $data['judul_care']; ?></td>
                                  <td><?php echo $data['des_care']; ?></td>

                                  <td>
                                    <a class="fas fa-trash" href="hapus-care.php?id_care=<?php echo $data['id_care'] ; ?>" onclick="return confirm('Data akan terhapus secara permanen!?')"></a>
                                    &nbsp;&nbsp;
                                    <a class="fas fa-fw fa-wrench" href="edit-care.php?id_care=<?php echo $data['id_care'] ; ?>" ></a>
                                  </td>
                                </tr>
                              <?php
                              }
