                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th scope="col">Judul Histori</th>
                                    <th scope="col">Deskripsi Histori</th>
                            ...
                            <tbody>
                              <?php
                              $no = 1;
                              $query = mysqli_query($koneksi, "SELECT * FROM histori");
                              while ($data = mysqli_fetch_assoc($query)) {
                              ?>
                                <tr>
                                  <td><?php echo $no++; ?></td>
                                  <td ><?php echo $data['id_histori']; ?></td>
                                  <td><?php echo $data['judul_histori']; ?></td>
                                  <td><?php echo $data['des_histori']; ?></td>
                                  <td><?php echo $data['id_laptop']; ?></td>

                                  <td>
                                    <a class="fas fa-trash" href="hapus-histori.php?id_histori=<?php echo $data['id_histori'] ; ?>" onclick="return confirm('Data akan terhapus secara permanen!?')"></a>
                                    &nbsp;&nbsp;
                                    <a class="fas fa-fw fa-wrench" href="edit-histori.php?id_histori=<?php echo $data['id_histori'] ; ?>" ></a>
                                  </td>
                                </tr>
                              <?php
                              }
