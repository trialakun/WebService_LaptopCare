        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="beranda.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Data Apliaksi</h3>
                </a>
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    <th scope="col">No</th>
                                    <th scope="col">Id Info Laptop</th>
                                    <th scope="col">Nama Info Laptop</th>
                                    <th scope="col">Deskripsi Info Laptop</th>
                            ...
                            <tbody>
                              <?php
                              $no = 1;
                              $query = mysqli_query($koneksi, "SELECT * FROM info_laptop");
                              while ($data = mysqli_fetch_assoc($query)) {
                              ?>
                                <tr>
                                  <td><?php echo $no++; ?></td>
                                  <td ><?php echo $data['id_info_laptop']; ?></td>
                                  <td><?php echo $data['nama_info_laptop']; ?></td>
                                  <td><?php echo $data['des_info_laptop']; ?></td>

                                  <td>
                                    <a class="fas fa-trash" href="hapus-info-laptopweb.php?id_info_laptop=<?php echo $data['id_info_laptop'] ; ?>" onclick="return confirm('Data akan terhapus secara permanen!?')"></a>
                                    &nbsp;&nbsp;
                                    <a class="fas fa-fw fa-wrench" href="edit-info-laptopweb.php?id_info_laptop=<?php echo $data['id_info_laptop'] ; ?>" ></a>
                                  </td>
                                </tr>
                              <?php
                              }
