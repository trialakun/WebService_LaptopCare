...
if (isset($_POST['login'])) {
  ...
  if (mysqli_num_rows($cek) > 0) {
    ...
    $_SESSION['nama_admin'] = $a->nm_admin;
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.php" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Laptop Care</h3>
                            </a>
                            <h3>Sign In</h3>
                        </div>
                        <form class="" action="" method="post">
                          <!--<div class="form-floating mb-3">
                              ...
                              <div class="form-floating mb-3">
                              <input type="text" name="user" class="form-control"id="floatingInput" value="" placeholder="username">
                              <label for="floatingInput">username</label>
                          </div>
                          ...
                          <div class="form-floating mb-4">
                          <input type="password" name="pass" class="form-control" id="floatingPassword" value=""placeholder="Password">
                          <label for="floatingPassword">Password</label>
                        </div>
