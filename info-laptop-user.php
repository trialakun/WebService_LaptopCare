                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td><?php echo $data['type_laptop']; ?></td>
                                  <td><?php echo $data['id_akun']; ?></td>

                                  <td>
                                    <a class="fas fa-trash" href="hapus-laptop.php?id_laptop=<?php echo $data['id_laptop'] ; ?>" onclick="return confirm('Data akan terhapus secara permanen!?')"></a>
                                    &nbsp;&nbsp;
                                    <a class="fas fa-fw fa-wrench" href="edit-laptop.php?id_laptop=<?php echo $data['id_laptop'] ; ?>" ></a>
                                  </td>
                                </tr>
                              <?php
                              }
